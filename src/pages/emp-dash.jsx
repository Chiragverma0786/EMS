...
const AdminDash = () => {
    ...
    const [bgColor, bgset] = useState("orangered")
    ...
    const hello =() =>{
        if(first == "6%"){
            ...
            displayset("flex")
            borderset("40px")
            bgset("linear-gradient(to left, #fff 50%, orangered 50%)")
            setRightWidth("30%")
    ...
    <div className="admin-body">
        ...
        <div className="admin-container">
            <div className="dash" style={{
                ...
                <div className="dash-bar" style={{
                    ...
                    <div className="dash-nav">
                        ...
                        fullWidth={widthOf} optionOne={"Admin Dashboard"} optionTwo={"Deals Dashboard"}/>
            ...
            <div className="admin">
                ...
                <Doughnut  data = {{
                    labels: ['Chirag', 'Anshul', 'Gautam'],
                    datasets: [{
                        labels: ['Chirag', 'Ritik', 'Amit'],
                        data: [300, 50, 100],
                        backgroundColor: [
                          'rgb(255, 99, 132)',
                          'rgb(54, 162, 235)',
